...
function mostrarTodoUsuario(idEmpleado) {
	$.ajax({
		...
		success: function (response) {
			...
			document.getElementById("did").value = response.Numero_did;
...
function mostarEquipoUsuario() {
	$.ajax({
		...
		success: function (response) {
			...
			document.getElementById("upsU").value = response.UPS_Serie;
...
select.addEventListener('change', function () {
	...
	$.ajax({
		...
		success: function (response) {
			document.getElementById("emailA").value = response.Correo_Conagua;
			document.getElementById("extensionA").value = response.Numero_Extension;
			document.getElementById("usuarioA").value = response.Usuario_Conagua;
			document.getElementById("idEmpleadoA").value = response.Id_empleado;
			document.getElementById("curpA").value = response.CURP;
			document.getElementById("didA").value = response.Numero_did;

			var puestoBuscar = response.NombrePuesto;
			...
			var areaBuscar = response.NombreArea;
			...
			var gerenciaBuscar = response.NombreGerencia;
...
function actualizarUsuarioBD() {
	let emailUpdate = document.getElementById("emailA").value;
	let extensionUpdate = document.getElementById("extensionA").value;
	let usuarioUpdate = document.getElementById("usuarioA").value;
	let didUpdate = document.getElementById("didA").value;
