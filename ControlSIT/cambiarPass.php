                        ...
                        <div class="card-body">
                            ...
                            <div id="logerror" style="color: red;text-align: center;">
                                ...
                                if (isset($_POST['login'])) {
                                    ...
                                    if ($nmysuario != 0) {
                                        $sql = "SELECT idUsuario, us.Contasena, p.Nombre_persona, uc.Usuario_Conagua, uc.Correo_Conagua FROM usuario us inner join empleado e on e.idEmpleado = us.idEmpleado inner join persona p on p.idPersona = e.idPersona inner join usuarioconagua uc on uc.idUsuarioConagua= e.idUsuarioConagua where uc.Usuario_Conagua =  '" . $_POST['usuario'] . "' and us.Contasena = '" . $_POST['password'] . "'";
