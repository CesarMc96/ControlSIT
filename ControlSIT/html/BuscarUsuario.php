    ...
    <div class="layout-container">
        <div class="content-wrapper">
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Buscar Usuario /</span> Usuario</h4>
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <form id="formAccountSettings" method="POST" onsubmit="return false">
                      ...
                      <label for="nombreCompletp" class="form-label">Nombre Completo</label>
                      <select id="nombreCompletp" class="select2 form-select">
                            ...
                            echo "<script>console.log('Console: " . $usuariosDatos[3][5] . "' );</script>";
                            ?>
                          </select>
                          </div>
                        <div class="mb-3 col-md-6">
