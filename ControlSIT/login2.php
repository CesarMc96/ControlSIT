...
<?php if (isset($_SESSION['autentica'])) {
  ...
  <head>
    ...
    <title>Control SIT</title>
    <link rel="icon" type="image/x-icon" href="./img/favicon/favicon.ico" />
    <link href="https://fonts.googleapis.com/css2?family=Public+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;1,300;1,400;1,500;1,600;1,700&display=swap" rel="stylesheet" />
    <link rel="stylesheet" href="./libs/fonts/boxicons.css" />
            ...
            <div class="card-body">
              ...
              <div id="logerror" style="color: red;text-align: center;">
                ...
                if (isset($_POST['login'])) {
                  ...
                  if ($nmysuario != 0) {
                    $sql = "SELECT idUsuario, us.Contasena, p.Nombre_persona, uc.Usuario_Conagua, uc.Correo_Conagua FROM usuario us
                    ...
                    where uc.Usuario_Conagua =  '" . $_POST['usuario'] . "' and us.Contasena = '" . $_POST['password'] . "'";
